...
@:final class Huffcodetab
{
    ...
    private var table : Array<Dynamic> = null;  /* pointer to array[xlen][ylen]		      */  
    private var hlen : Array<Dynamic> = null;  /* pointer to array[xlen][ylen]		      */  
    private var val : Array<Dynamic> = null;  /* decoder tree		    	          	  */  
    private var treelen : Int;  /* length of decoder tree  	              */  
    
    private static var ValTab0 : Array<Dynamic> = [[0, 0]];  // dummy  
    
    private static var ValTab1 : Array<Dynamic> = [[2, 1], [0, 0], [2, 1], [0, 16], [2, 1], [0, 1], [0, 17]];
    
    private static var ValTab2 : Array<Dynamic> = [[2, 1], [0, 0], [4, 1], [2, 1], [0, 16], [0, 1], [2, 1], [0, 17], [4, 1], [2, 1], 
        [0, 32], [0, 33], [2, 1], [0, 18], [2, 1], [0, 2], [0, 34]
    ];
    
    private static var ValTab3 : Array<Dynamic> = [[4, 1], [2, 1], [0, 0], [0, 1], [2, 1], [0, 17], [2, 1], [0, 16], [4, 1], [2, 1], 
        [0, 32], [0, 33], [2, 1], [0, 18], [2, 1], [0, 2], [0, 34]
    ];
    
    private static var ValTab4 : Array<Dynamic> = [[0, 0]];  // dummy  
    
    private static var ValTab5 : Array<Dynamic> = [[2, 1], [0, 0], [4, 1], [2, 1], [0, 16], [0, 1], [2, 1], [0, 17], [8, 1], [4, 1], 
        [2, 1], [0, 32], [0, 2], [2, 1], [0, 33], [0, 18], [8, 1], [4, 1], [2, 1], [0, 34], 
        [0, 48], [2, 1], [0, 3], [0, 19], [2, 1], [0, 49], [2, 1], [0, 50], [2, 1], [0, 35], 
        [0, 51]
    ];
    
    private static var ValTab6 : Array<Dynamic> = [[6, 1], [4, 1], [2, 1], [0, 0], [0, 16], [0, 17], [6, 1], [2, 1], [0, 1], [2, 1], 
        [0, 32], [0, 33], [6, 1], [2, 1], [0, 18], [2, 1], [0, 2], [0, 34], [4, 1], [2, 1], 
        [0, 49], [0, 19], [4, 1], [2, 1], [0, 48], [0, 50], [2, 1], [0, 35], [2, 1], [0, 3], 
        [0, 51]
    ];
    
    private static var ValTab7 : Array<Dynamic> = [[2, 1], [0, 0], [4, 1], [2, 1], [0, 16], [0, 1], [8, 1], [2, 1], [0, 17], [4, 1], 
    ...
    private static var ValTab8 : Array<Dynamic> = [[6, 1], [2, 1], [0, 0], [2, 1], [0, 16], [0, 1], [2, 1], [0, 17], [4, 1], [2, 1], 
    ...
    private static var ValTab9 : Array<Dynamic> = [[8, 1], [4, 1], [2, 1], [0, 0], [0, 16], [2, 1], [0, 1], [0, 17], [10, 1], [4, 1], 
    ...
    private static var ValTab10 : Array<Dynamic> = [[2, 1], [0, 0], [4, 1], [2, 1], [0, 16], [0, 1], [10, 1], [2, 1], [0, 17], [4, 1], 
    ...
    private static var ValTab11 : Array<Dynamic> = [[6, 1], [2, 1], [0, 0], [2, 1], [0, 16], [0, 1], [8, 1], [2, 1], [0, 17], [4, 1], 
    ...
    private static var ValTab12 : Array<Dynamic> = [[12, 1], [4, 1], [2, 1], [0, 16], [0, 1], [2, 1], [0, 17], [2, 1], [0, 0], [2, 1], 
    ...
    private static var ValTab13 : Array<Dynamic> = [[2, 1], [0, 0], [6, 1], [2, 1], [0, 16], [2, 1], [0, 1], [0, 17], [28, 1], [8, 1], 
    ...
    private static var ValTab14 : Array<Dynamic> = [[0, 0]];  // dummy  
    
    private static var ValTab15 : Array<Dynamic> = [[16, 1], [6, 1], [2, 1], [0, 0], [2, 1], [0, 16], [0, 1], [2, 1], [0, 17], [4, 1], 
    ...
    private static var ValTab16 : Array<Dynamic> = [[2, 1], [0, 0], [6, 1], [2, 1], [0, 16], [2, 1], [0, 1], [0, 17], [42, 1], [8, 1], 
    ...
    private static var ValTab24 : Array<Dynamic> = [[60, 1], [8, 1], [4, 1], [2, 1], [0, 0], [0, 16], [2, 1], [0, 1], [0, 17], [14, 1], 
    ...
    private static var ValTab32 : Array<Dynamic> = [[2, 1], [0, 0], [8, 1], [4, 1], [2, 1], [0, 8], [0, 4], [2, 1], [0, 1], [0, 2], 
        [8, 1], [4, 1], [2, 1], [0, 12], [0, 10], [2, 1], [0, 3], [0, 6], [6, 1], [2, 1], 
        [0, 9], [2, 1], [0, 5], [0, 7], [4, 1], [2, 1], [0, 14], [0, 13], [2, 1], [0, 15], 
        [0, 11]
    ];
    
    private static var ValTab33 : Array<Dynamic> = [[16, 1], [8, 1], [4, 1], [2, 1], [0, 0], [0, 1], [2, 1], [0, 2], [0, 3], [4, 1], 
    ...
    public static var ht : Array<Dynamic> = null;  /* Simulate extern struct                 */  
    
    private static var bitbuf : Array<Dynamic> = new Array<Dynamic>(32);
    
    /**
	   * Big Constructor : Computes all Huffman Tables.
	   */
    public function new(S : String, XLEN : Int, YLEN : Int, LINBITS : Int, LINMAX : Int, REF : Int,
            TABLE : Array<Dynamic>, HLEN : Array<Dynamic>, VAL : Array<Dynamic>, TREELEN : Int)
    {
    ...
    /**
	   ...
	   * discard x.
	   */
    public static function huffman_decoder(h : Huffcodetab, x : Array<Dynamic>, y : Array<Dynamic>, v : Array<Dynamic>, w : Array<Dynamic>, br : BitReserve) : Int
    {
        // array of all huffcodtable headers
        // 0..31 Huffman code table 0..31
        // 32,33 count1-tables
        
        var dmask : Int = 1 << as3hx.Compat.parseInt((4 * 8) - 1);
        var hs : Int = as3hx.Compat.parseInt(4 * 8);
        var level : Int;
        var point : Int = 0;
        var error : Int = 1;
        level = dmask;
        ...
        {
            v[0] = as3hx.Compat.parseInt(y[0] >> 3) & 1;
            w[0] = as3hx.Compat.parseInt(y[0] >> 2) & 1;
            x[0] = as3hx.Compat.parseInt(y[0] >> 1) & 1;
            y[0] = y[0] & 1;
