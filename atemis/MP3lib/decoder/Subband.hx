...
class Subband
{
    ...
    public static var scalefactors : Array<Dynamic> = 
        [
    ...
    public function read_sampledata(stream : Bitstream) : Bool
    {
        return false;
    }
    
    public function put_next_sample(channels : Int, filter1 : SynthesisFilter, filter2 : SynthesisFilter) : Bool
    {
        return false;
    }
